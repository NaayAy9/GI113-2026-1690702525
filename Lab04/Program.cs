...
internal class Program
{
    ...
    {
        Console.WriteLine("---------------------"); // แค่ title ความงาม
        Console.WriteLine("|   NEW ADVENTURE   |");
        Console.WriteLine("---------------------");

        Console.WriteLine("Name your hero: ");
        Console.WriteLine(">>> ");
        string playerName = Console.ReadLine(); // รับ input
        ...
        bool quantityOk = int.TryParse(Console.ReadLine(), out int quantity2);
        Console.WriteLine($"Valid input: {quantityOk}");
        Console.WriteLine($"Quantity: {quantity2}");
